...
const items = [
  {
    ...
    text: 'Считаем даты от ПДР малыша. Недоношенность учитывается.',
  },
  {
    icon: 'journal-outline' as const,
    title: 'Журнал поведения',
    text: 'Настроение, симптомы, заметки — за 10 секунд в день.',
  },
  {
    icon: 'notifications-outline' as const,
    title: 'Мягкие напоминания',
    text: 'За 3 дня до скачка — чтобы подготовиться.',
  },
];
...
export default function HowItWorks() {
  ...
  return (
    <OnboardingShell
      ...
      subtitle="Три простых вещи, которые делают повседневную жизнь с малышом понятнее."
      footer={
        <>
